...
let contractAddress: string = process.env.BSC_CONTRACT_ADDRESS_AUCTION!;
let monitorWss: string = process.env.API_WSS_BSC!;
let monitorHttps: string = process.env.API_HTTP_BSC!;
// 将 JSON 字符串解析为对象
