...
let contractAddress: string = process.env.MAIN_CONTRACT_ADDRESS_V2!;
let monitorWss: string = process.env.API_WSS_MAIN!;
let monitorHttps: string = process.env.API_HTTP_MAIN!;
// 将 JSON 字符串解析为对象
