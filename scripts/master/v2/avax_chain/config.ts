...
let contractAddress: string = process.env.AVAX_CONTRACT_ADDRESS_V2!;
let monitorWss: string = process.env.API_WSS_AVAX!;
let monitorHttps: string = process.env.API_HTTP_AVAX!;
// 将 JSON 字符串解析为对象
