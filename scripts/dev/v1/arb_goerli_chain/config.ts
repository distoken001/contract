...
let contractAddress: string = process.env.ARB_GOERLI_CONTRACT_ADDRESS!;
let monitorWss: string = process.env.API_WSS_ARB_GOERLI!;
let monitorHttps: string = process.env.API_HTTP_ARB_GOERLI!;
// 将 JSON 字符串解析为对象
