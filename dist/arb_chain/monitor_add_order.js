...
function op_monitor_add_order() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const contract = new ethers_1.ethers.Contract(config_1.opContractAddress, config_1.contractABI, config_1.opProviderHttps);
        const topic1 = ethers_1.ethers.utils.id("AddOrder(address,uint256)");
        let filter = {
            address: config_1.opContractAddress,
            topics: [topic1],
        };
        config_1.opProviderHttps.on(filter, (result) => __awaiter(this, void 0, void 0, function* () {
            console.log(result);
